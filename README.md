...
If you try to decode plaintext directly (i.e. pass plaintext instead of ciphertext to the script in non-encrypt mode) you'll get a different output. That is expected — the script treats whatever you pass as ciphertext unless you use `--encrypt`.
