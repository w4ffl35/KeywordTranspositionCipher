...
class BasicCryptanalysis(object):
    ...
    def run(self):
        ...
        while running:
            ...
            # iterate over the prepared dict
            # new_prepared_dict = []
            for key in prepared_dictionary:
                # create an array with one element each to use with each
                # encrypted secret.
                # prepared_crypto = [key for c in self.prepared_secrets]
            ...
            #             newk += k
            #
            #     if newk != '' and newk not in self.used_keys:
            #         running = True
            #         new_prepared_dict = [newk]
            #         self.used_keys.append(newk)
            #         print newk
